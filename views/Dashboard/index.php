<?php
require 'views/Dashboard/userdashboard.php';
?>
...
<?php
  ...
  <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col mt-3">
    <div class="card m-auto mt-2">
      ...
      <a href="User/addm?mid=<?=$row["mid"]?>" class="btn btn-primary">view</a>
      <!--  <a href="Movie/Updatemovie?mid=<?=$row["mid"]?>" class="btn btn-primary">view</a>-->
      </div>
    </div>
  </div>
  <?php } ?>
