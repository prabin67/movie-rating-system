                ...
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <div class="card rounded shadow shadow-sm">
                        <div class="card-header">
                            <h3 class="mb-0"> Critics Login</h3>
                        </div>
                        <div class="card-body">
                            <form class="form" role="form" autocomplete="off" id="formLogin" action="Critic/CloginCheck" method="POST">
                                ...
                                <br>
                                <br>
                                <a href="Home/Display" class="btn btn-danger">Cancel</a>
