    ...
    <div class="col-md-6 min-vh-100 d-flex flex-column justify-content-center">
        <div class="card rounded shadow shadow-sm">
             <div class="card-header">
                <h3 class="mb-0"> User Regristration Form</h3>
            </div>
            <div class="card-body">
            <form class="mt-3" method="POST" action="/movie/User/UserRegistration">
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="firstname">Name<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="name" placeholder="Full Name" required="" id="name" />
                        </div>
                    </div>
                </div>
                <div class="row">
...
console.clear();
    ...
    let confirm_password = document.querySelector("#cpassword");
